        ...
        <div class='panel panel-default'>
          ...
          <div class='panel-body'>
            <div class='page-header'>
              <h3>本日のRT数ランキング　Best3</h3>
            </div>
            <div class='row text-center'>

              <table border="5" width="70%">
                <tr><th>No</th><th>名前</th><th>ツイート</th><th>RT数</th></tr>
                <?php $i=1; while($rows = $stmt_rt->fetch(PDO::FETCH_ASSOC)){?>
                    <tr>
                        <td width="5%"><?= $i; $i++;?></td>
                ...
                <?php }  ?>
                <input type="button"class="square_btn2" onclick="location.href='./dashboard.php'" value="いいね数ランキング">
                <input type="button"class="square_btn2" onclick="location.href='./dashboard_fler.php'" value="フォロワー数ランキング">
