...
//DB内でPOSTされたメールアドレスを検索
    $tweet = new Tweet();
    $stmt_rt_all_today = $tweet->rt_all_today();
?>
    ...
    <div id='wrapper'>
      ...
      <section id='tools'>
        <ul class='breadcrumb' id='breadcrumb'>
          <li class='title'>
              <a href="./rt_best3_today.php">Best3</a>
          </li>
          <li class='title'>
              <a href="./rt_all_today.php">All Rankings</a>
          </li>
        </ul>
      </section>
        ...
        <div class='panel panel-default grid'>
          ...
          <div class='panel-body'>
            <table class='table table-bordered'>
              ...
              <tbody>
                <?php $i=1; while($rows = $stmt_rt_all_today->fetch(PDO::FETCH_ASSOC)){?>
                  <tr class='table' height="50">
                    <td width="5%"><?= $i; $i++;?></td>
